...
} from "@/modules/subtracker/lib/layoutStore";
import {
  History, BellRing, SlidersHorizontal,
  Plus, LogOut, Search, User as UserIcon, Mail, Sparkles,
} from "lucide-react";
import { useAuth } from "@/modules/auth";
import { useSubscriptions } from "@/modules/subtracker/hooks/useSubscriptions";
import { useEmis } from "@/modules/subtracker/hooks/useEmis";
import { useCards } from "@/modules/subtracker/hooks/useCards";
import { useAccounts } from "@/modules/subtracker/hooks/useAccounts";
import { useReceivables } from "@/modules/subtracker/hooks/useReceivables";
import { useCapex } from "@/modules/subtracker/hooks/useCapex";
import { useRent } from "@/modules/subtracker/hooks/useRent";
import { useSmartAllocation } from "@/modules/subtracker/hooks/useSmartAllocation";
import { useDashboard } from "@/modules/subtracker/hooks/useDashboard";
import { usePeriodSummary } from "@/modules/subtracker/hooks/useFilteredCCTotal";
import type { DashboardFilters } from "@/modules/subtracker/types";
...
import { Onboarding, useOnboarding, replayTour } from "@/components/Onboarding";
